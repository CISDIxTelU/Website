        ...
        <>
            ...
            <div className='container mx-auto p-3'>
                ...
                <div className='border-l-8 border-r-8 rounded-lg p-3 bg-gray-200 border-red-600 mb-5'>
                    <div className='rounded-full bg-red-200 mx-auto my-10' style={{width: "200px", height: "200px"}}>
                    ...
                    <div className='mx-20 mb-3'>
                        ...
                        <input type="text" placeholder="Nama lengkap anda" className='w-full rounded p-2' />
                    </div>
                    <div className='mx-20 mb-3'>
                        <p className='font-bold text-md mb-2'>Asal Instansi</p>
                        <div className='relative inline-block w-full text-gray-700'>
                            <select class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Asal instansi anda...">
                    ...
                    <div className='mx-20 mb-3'>
                        <p className='font-bold text-md mb-2'>Kata Sandi</p>
                        <input type="text" placeholder="Nama lengkap anda" className='w-full rounded p-2' />
                    </div>
