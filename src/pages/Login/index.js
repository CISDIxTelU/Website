                    ...
                    <div className="filter mx-auto rounded-md py-11 w-64 mt-5 lg:w-4/12">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="border rounded-lg flex wrap items-center content-center mb-5">
                                ...
                                <input data-testid="username-input" type="text" onChange={e => setUsername(e.target.value)} className="appearance-none bg-transparent text-white w-full h-full p-3 rounded-lg focus:outline-none text-sm lg:text-base" placeholder="Enter your username"></input>
                            </div>
                            <div className="border rounded-lg flex wrap items-center content-center mb-11">
                                <FaLock className="text-white mx-5" />
                                <input data-testid="password-input" type="password" onChange={e => setPassword(e.target.value)} className="appearance-none bg-transparent text-white w-full h-full p-3 rounded-lg focus:outline-none text-sm lg:text-base" placeholder="Enter your password"></input>
                            </div>
                            <button className="bg-white text-red-600 rounded-lg p-2 w-full mb-5 hover:bg-red-700 hover:text-white" data-testid="submit" type="submit" onSubmit={handleSubmit}>Masuk</button>
